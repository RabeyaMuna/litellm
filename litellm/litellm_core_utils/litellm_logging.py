            ...
            if self.logger_fn and callable(self.logger_fn):
                try:
                    ...
                    try:
                        ...
                        # If logging handlers are closed, fallback to stderr
                        try:
                            import sys
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print(
                                f"litellm.Logging.pre_call(): Exception occured - {str(e)}",
                                file=sys.stderr,
                            )
                        except Exception:
                            pass
        ...
        try:
            ...
            if json_logs:
                try:
                    ...
                    # If logging handlers are closed, fallback silently
                    pass
            else:
                try:
                    print_verbose(
                ...
                if (
                    ...
                    if "response_cost" in hidden_params:
                        ...
                        try:
                            ...
                            # Safely handle any errors from cost calculation or closed logging handlers
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                print(f"[Non-Blocking Error] Error initializing custom logger: {e}", file=sys.stderr)
            except Exception:
                pass
        return None
